...
import { removeCollaborator, updatedDocumentAccess } from "@/lib/actions/room.actions";
...
const Collaborator = ({ roomId, creatorId, collaborator, email, user }: CollaboratorProps) => {
  ...
  const shareDocumentHandler = async (type: string) => {
    setLoading(true);
    await updatedDocumentAccess({ roomId, email, userType: type as UserType, updatedBy: user });
    setLoading(false);
  };
