...
import { updatedDocumentAccess } from "@/lib/actions/room.actions";
...
const ShareModal = ({ roomId, collaborators, creatorId, currentUserType }: ShareDocumentDialogProps) => {
  ...
  const shareDocumentHandler = async () => {
    setLoading(true);
    await updatedDocumentAccess({ roomId, email, userType: userType as UserType, updatedBy: user.info });
    setLoading(false);
  };
