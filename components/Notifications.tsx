...
const Notifications = () => {
  ...
  return (
    <Popover>
      <PopoverTrigger className="relative fledx size-10 items-center justify-center rounded-lg">
        <Image
      ...
      <PopoverContent
        ...
        <LiveblocksUIConfig overrides={{ INBOX_NOTIFICATION_TEXT_MENTION: (user: ReactNode) => <>{user} mentioned you.</> }}>
